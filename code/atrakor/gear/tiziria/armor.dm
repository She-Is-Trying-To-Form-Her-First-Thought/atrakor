...
/obj/item/clothing/head/lizard_helmet
	...
	desc = "A distinctly Tizirian designed helmet, special made to fit and long enough to the front to protect \
		...
		profile, increasing strength. This one is tan to denote the owner is a conscripted levy."
...
/obj/item/clothing/head/lizard_helmet/glass
	name = "tan Tizirian helmet"
	desc = "A distinctly Tizirian designed helmet, special made to fit and long enough to the front to protect \
		an array of snout sizes from the top down. This gives a secondary benefit of heavily angling the front \
...
/obj/item/clothing/head/lizard_helmet/white
	...
	desc = "A distinctly Tizirian designed helmet, special made to fit and long enough to the front to protect \
		an array of snout sizes from the top down. This gives a secondary benefit of heavily angling the front \
		profile, increasing strength. This one is white to denote the owner is an army regular."
	icon_state = "halo_reg"
	worn_icon_state = "halo_reg"

/obj/item/clothing/head/lizard_helmet/white/glass
	name = "white Tizirian helmet"
	desc = "A distinctly Tizirian designed helmet, special made to fit and long enough to the front to protect \
		an array of snout sizes from the top down. This gives a secondary benefit of heavily angling the front \
		profile, increasing strength. This one has a protective eye shield made of reflective orange glass, \
...
/obj/item/clothing/armor_slot/lizard
	...
	desc = "The most common type of Tizirian armor, a hefty breastplate supported at the shoulders and midsection \
		by interwoven scales of armor, not too much unlike those who wear the armor."
	icon = 'icons/atrakor/tiziria/gear.dmi'
	icon_state = "armor"
	worn_icon = 'icons/atrakor/tiziria/gear_worn.dmi'
